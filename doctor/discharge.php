                            ...
                            <div class="col-md-6">
                                ...
                                if (isset($_POST['send'])) {
                                    ...
                                    if (empty($des)) {
                                        ...
                                        $query = "INSERT INTO income(doctor,patient,date_discharge,,amount_paid,description) VALUES('$doc','$fname','','500','$des')";
